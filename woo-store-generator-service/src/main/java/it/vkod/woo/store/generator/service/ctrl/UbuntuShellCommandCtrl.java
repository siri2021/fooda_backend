package it.vkod.woo.store.generator.service.ctrl;

import it.vkod.woo.store.generator.service.srv.impl.UbuntuDummyStoreProcessorSrvImpl;
...
public class UbuntuShellCommandCtrl {
    ...
    @Autowired
    private UbuntuDummyStoreProcessorSrvImpl service;
