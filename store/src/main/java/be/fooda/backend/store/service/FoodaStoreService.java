...
public interface FoodaStoreService<REQ, RES> {
    ...
    List<RES> getStoreByDeliveryCost(final Integer minPrice, final Integer maxPrice, BigDecimal amount);

    List<RES> getStoreByDeliveryCost(final Integer minPrice, final Integer maxPrice);
    ...
    Optional<RES> addStore(final REQ storeReq);
