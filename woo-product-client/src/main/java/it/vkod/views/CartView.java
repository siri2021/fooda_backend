...
public class CartView extends Div {
    ...
    public void init() {
        ...
        completeOrderDiv.setClassName("card-panel blue");
        completeOrderDiv.getStyle().set("margin", "0").set("padding", "0").set("height", "48px");
        ...
        completeOrderButton.getStyle().set("margin", "0").set("padding", "0").set("height", "48px").set("width", "100%");
