...
@PWA(name = "Fooda Resto App", shortName = "Resto")
@Component
...
public class MainAppLayout extends AppLayoutRouterLayout<LeftLayouts.LeftResponsive> {
    ...
    @Getter
    private final transient DefaultBadgeHolder badge = new DefaultBadgeHolder(0);
    ...
    public MainAppLayout() {
        ...
        final LeftNavigationItem search = new LeftNavigationItem("Tables", VaadinIcon.TABLE.create(), TablesLayout.class);
        final LeftNavigationItem shops = new LeftNavigationItem("Customers", VaadinIcon.FAMILY.create(), CustomersLayout.class);
        ...
        final LeftNavigationItem orders = new LeftNavigationItem("Orders", VaadinIcon.CALENDAR.create(), OrdersLayout.class);
        init(AppLayoutBuilder.get(LeftLayouts.LeftResponsive.class)
                ...
                .withAppBar(AppBarBuilder.get().add(new NotificationButton<>(VaadinIcon.BELL, notifications))
                        .build())
                .withAppMenu(LeftAppMenuBuilder.get().add(home, search, shops, basket, delivery, orders, payment)
                        .build())
                .build());
    }
}
